from fastapi import FastAPI, Depends, Request, Response, status, File, Form
...
async def save_did_lines(request: Request, response: Response, uuid: str, api_key: str = Depends(api_key_header)):
    if api_key != "secret":
    ...
    try:
        ...
        doc_state = toolbox.DidDocumentState._from(file)
